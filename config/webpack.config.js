  ...
  return {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin({
        patterns: [
          { from: 'src/env.js', to: 'env.js?t=[hash]' },
          { from: 'src/configData.json', to: 'configData.json?t=[hash]' },
          { from: 'src/Azura_Deck.pdf', to: 'Azura_Deck.pdf?t=[hash]' },
          { from: 'src/assetlinks.json', to: 'dist/.well-known/assetlinks.json?t=[hash]' },
          {
            from: 'src/apple-app-site-association.json',
            to: 'dist/.well-known/apple-app-site-association.json?t=[hash]',
          },
          { from: 'src/apple-app-site-association', to: 'dist/.well-known/apple-app-site-association?t=[hash]' },
        ],
      }),
    ].filter(Boolean),
