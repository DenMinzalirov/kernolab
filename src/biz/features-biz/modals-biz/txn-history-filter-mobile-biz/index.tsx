...
export function TxnHistoryFilterMobileBiz({ title, data, selectedItems, submit, itemComponent }: Props): JSX.Element {
  ...
  return (
    <div className={styles.containerModal}>
      <div className={styles.contentWrapModal}>
        ...
        <button onClick={handleSubmit} className='btn-biz blue big'>
          Apply
        </button>
      </div>
    </div>
