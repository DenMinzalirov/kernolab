...
export function KYC() {
  ...
  return (
    <AuthLayoutBiz>
      ...
      {/*  <img height={49} src={fideumOnboardingLogo} alt='' />*/}
      {/*</div>*/}
      {/*<BackButton backFn={() => navigate(pages.SignIn.path)} />*/}

      {!hideBtn && (
        // <div className={clsx(styles.formWrap)}>
        <div className={clsx(styles.rightModule)}>
      ...
      <div
        className={styles.rightModule}
        style={{ backgroundColor: 'white', display: hideBtn ? 'block' : 'none' }}
